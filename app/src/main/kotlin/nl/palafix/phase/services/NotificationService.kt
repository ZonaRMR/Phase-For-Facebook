...
import nl.palafix.phase.dbflow.loadFbCookiesSync
...
class NotificationService : JobService() {
    ...
    override fun onStopJob(params: JobParameters?): Boolean {
        ...
        phaseAnswersCustom("NotificationTime",
    ...
    private fun Context.debugNotification(text: String = string(R.string.kau_lorem_ipsum)) {
        ...
        val notifBuilder = phaseNotification.withDefaults()
                .setContentTitle(string(R.string.phase_name))
                .setContentText(text)
