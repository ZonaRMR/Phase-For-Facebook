 ...
 */
interface PhaseContentContainer {
 ...
 */
interface PhaseContentParent : DynamicUiContract {
     ...
     */
    fun bind(container: PhaseContentContainer)
 ...
 */
interface PhaseContentCore : DynamicUiContract {

    /**
     * Reference to parent
     * Bound through calling [PhaseContentParent.bind]
     */
    var parent: PhaseContentParent
     ...
     */
    fun bind(container: PhaseContentContainer): View
