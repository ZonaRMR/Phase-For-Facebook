 ...
 */
class PhaseVideoView @JvmOverloads constructor(
    ...
    private lateinit var viewerContract: PhaseVideoViewerContract
    lateinit var containerContract: PhaseVideoContainerContract
    ...
    fun setViewerContract(contract: PhaseVideoViewerContract) {
